                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3 ">
                                        ...
                                        <input type="text" name="site_title" id="site_title_inp" class="form-control shadow-none" required></input>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <p class="card-text mb-1">
                                        ...
                                        <span id="pn1" class=""></span>
                                    </p>

                                    <p class="card-text">
                                        <i class="bi bi-telephone"></i>
                                        <span id="pn2" class=""></span>
                                    </p>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <p class="card-text mb-1">
                                        ...
                                        <span id="insta" class=""></span>
                                    </p>

                                    <p class="card-text">
                                        <i class="bi bi-twitter-x"></i>
                                        <span id="tw" class=""></span>
                                    </p>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3 ">
                                                    ...
                                                    <input type="text" name="gmap" id="gmap_inp" class="form-control shadow-none" required></input>
                                                </div>
                                                ...
                                                <div class="mb-3 ">
                                                    ...
                                                    <input type="text" name="email" id="email_inp" class="form-control shadow-none" required></input>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3 ">
                                        ...
                                        <input type="text" name="member_name" id="member_name_inp" class="form-control shadow-none" required></input>
                                    </div>

                                    <div class="mb-3 ">
                                        <label class="form-label fw-bold">Picture</label>
                                        <input type="file" name="member_picture" id="member_picture_inp" accept=".jpg, .png, .webp, .jpeg" class="form-control shadow-none" required></input>
                                    </div>
                                </div>
                                <div class="modal-footer">
